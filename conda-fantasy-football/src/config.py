"""Configuration constants for CPR Fantasy Football."""
...
# Match Details CSV Column Names (after headers)
# The CSV uses column index-based names like '_1', '_2', etc.
MATCH_COLUMNS = {
    "DATE": "_1",
    "FEE": "_2",
    "GAMEWEEK": "_3",
...
SEASON_CONFIG = {
    ...
    "PAYMENT_START_DATE": datetime(2025, 8, 1),  # August 1, 2025
}
